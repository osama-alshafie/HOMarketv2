				...
				<div class="col-md-8 col-lg-9 p-b-75">
					<div class="p-r-50 p-r-0-lg">
						...
						<div class="item-blog p-b-80">
							<a href="blog-detail.jsp" class="item-blog-img pos-relative dis-block hov-img-zoom">
							...
							<div class="item-blog-txt p-t-33">
								<h4 class="p-b-11">
									<a href="blog-detail.jsp" class="m-text24">
								...
								<a href="blog-detail.jsp" class="s-text20">
									Continue Reading
