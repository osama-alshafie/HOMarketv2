...
<head>
    ...
    <link rel="stylesheet"
          href="<spring:url value="/resources/css/hover-min.css"/>"
          type="text/css"/>
    <link rel="stylesheet"
          href="<spring:url value="/resources/js/main.js"/>" type="text/css"/>

    <spring:url value="/resources/js/html5shiv.min.js" var="kmk9"></spring:url>
    <script src="${kmk9}"></script>

    <spring:url value="/resources/js/respond.min.js" var="kmk11"></spring:url>
    <script src="${kmk11}"></script>
...
<spring:url value="/resources/JsFiles/jquery-1.12.0.js" var="kmk3"></spring:url>
<script src="${kmk3}"></script>
<spring:url value="/resources/JsFiles/bootstrap.min.js" var="kmk4"></spring:url>
<script src="${kmk4}"></script>
<spring:url value="/resources/JsFiles/jquery.js" var="kmk5"></spring:url>
<script src="${kmk5}"></script>
<spring:url value="/resources/JsFiles/jquery.nicescroll.min.js"
            var="${kmk6}"></spring:url>
<script src="${kmk6}"></script>
<spring:url value="/resources/JsFiles/home.js" var="kmk7"></spring:url>
<script src="${kmk7}"></script>
<spring:url value="/resources/JsFiles/typed.min.js" var="kmk8"></spring:url>
<script src="${kmk8}"></script>
